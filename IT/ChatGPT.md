...
# отзыв
Помоги мне сформулировать отзыв на фильм, книгу или рассказ.

Работаем в два этапа.

1. Сначала проведи со мной короткий интерактивный разбор. Задавай строго по одному вопросу и жди моего ответа перед следующим. Начни с общей оценки и впечатления, затем уточняй именно те мысли, которые появляются в моих ответах. Не задавай заранее фиксированный список вопросов.

2. Ищи не пересказ сюжета, а моё отношение к произведению: что зацепило, что раздражало, какие идеи я увидел, с чем согласен или не согласен, насколько убедительны персонажи, мир и поступки, какие мысли произведение вызвало уже у меня самого.

3. Разделяй:

- что действительно следует из произведения;
- мою интерпретацию;
- мои собственные размышления, возникшие после прочтения или просмотра.
  Не приписывай автору мои мысли, если неизвестно, закладывал ли он их.

4. Не пытайся искусственно искать глубокий смысл. Если произведение для меня простое, поверхностное, развлекательное или вообще ничего не вызвало - так и оставляем. Но если в моём ответе появляется интересная мысль, помоги её развить дополнительными вопросами.

5. Можешь спорить со мной и предлагать альтернативное прочтение. Если моя логика спорная или в ней есть противоречие, укажи на это и спроси, что я думаю. Не соглашайся со мной автоматически.

6. Помогай определить оценку по шкале 1-10, сравнивая впечатление с моими предыдущими оценками, если они известны. Оценка должна соответствовать тому, что я реально рассказал о произведении.

7. Когда материала достаточно, скажи об этом и предложи закончить опрос. Не растягивай его вопросами, которые уже ничего существенного не добавляют.

8. По итогам напиши отзыв от моего лица. Сохрани мои основные мысли, логику и характерные удачные формулировки, но убери повторы и приведи всё к связной структуре. Не превращай текст в профессиональную литературную или кинокритическую рецензию, если я сам так не рассуждал.

9. По умолчанию отзыв должен быть коротким: примерно 1-3 абзаца. Если мыслей действительно много и они того стоят, можно сделать длиннее. Не увеличивай объём ради объёма.

10. Главный принцип: итоговый отзыв должен звучать так, будто я сумел хорошо структурировать и сформулировать собственные мысли, а не будто критик написал рецензию вместо меня.