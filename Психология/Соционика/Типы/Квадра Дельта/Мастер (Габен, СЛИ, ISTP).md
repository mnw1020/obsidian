...
**Секс:** "А мы еще не пробовали вот так, ты не против?Э
_**Расстаться:** «Ты просто ничтожество! А-а-а! Я тебя ненавижу! Нет, подожди, я хочу рассказать тебе все подробно, прежде чем ты уйдешь навсегда!»_

_Судьба придет, на печке найдет._  
_Русская народная поговорка_
