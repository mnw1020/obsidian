...
Никогда не возьмется за бессмысленную работу. Бережлив в обращении с материальными ресурсами. Умелый мастер, предпочитающий починить практически любую вещь, нежели её выбросить. Прекрасно работает руками. Перед тем, как начать что-то делать, он сначала придумывает, как это сделать эффективней, чтобы меньше работать, но больше получить в результате. Делает лишь те дела, которые необходимы, не терпит суеты. Видит халтурщиков, и умеет отделять их от работяг. Мастерски владеет инструментами и техническими приспособлениями. Упорно совершенствует себя в выбранном виде деятельности
