...
По отдельным фразам, интонации, мимике, особенностям поступков воссоздает внутреннюю мотивацию человека. Легко догадывается, чего тот добивается. Всегда знает, от кого чего ожидать, и какова уязвимая точка человека, чтобы использовать это для достижения своих целей. Чувствуют любое изменение настроения и поведения человека. Хорошо понимает, кого нужно поддержать и к кому примкнуть, чтобы получить выгоду для себя. Его часто не любят за это, но его это мало волнует, так как он никогда не считает себя виноватым. 
...
Ему невыносимо заниматься однообразной работой. Порождающая скуку повторяемость его сильно угнетает. Есть сложности в решении бытовых проблем, требующих рутинной физической деятельности — с трудом можете создать уют, комфортные условия для работы и отдыха.Быстро обучается, так как умеет схватить суть проблемы.  
...
Любит активно спорить, отстаивая свое мнение. Аргументы оппонентов обычно не слушает и игнорирует факты, противоречащие его представлениям. Очень независим сам и не станет принуждать кого-нибудь другого. Ему не хватает воли, чтобы заставит себя выполнить то, что объективно необходимо (или то, что обещал).
...
В общении старается быть легким, при этом внутри у Гексли кипит буря, которую он тщательно скрывает. Очень не любят когда их критикуют, но прекрасно умеют скрывать свое состояние и не признают своего поражения. Лишь в крайнем случае способен выплеснуть все эмоции на другого человека. Чтобы отвлечься, уходит в работу. При этом плохо чувствует меру — склонен перенапрягаться или перерабатывать.  
