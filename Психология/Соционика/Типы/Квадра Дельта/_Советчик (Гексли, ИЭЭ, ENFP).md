...
Ему невыносимо заниматься однообразной работой. Порождающая скуку повторяемость его сильно уыыыыгнетает. Быстро обучается, так как умеет схватить суть проблемы.  
