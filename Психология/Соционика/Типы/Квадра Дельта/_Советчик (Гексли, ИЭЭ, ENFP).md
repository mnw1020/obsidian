...
Прекрасно держатся на сцене, наличие публики только разогревает их.
Нередко в Вас проявляется актерский талант, что на бытовом уровне выражается в умении импровизировать, подражать голосам и манерам других.  
