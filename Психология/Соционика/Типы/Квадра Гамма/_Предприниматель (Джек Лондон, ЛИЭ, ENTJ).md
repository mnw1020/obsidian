...
Сам о себе может и не позаботиться, и именно поэтому забота со стороны партнера должна быть предельно предусмотрительной. Важно, чтобы ему были созданы все условия для полноценного отдыха.  
