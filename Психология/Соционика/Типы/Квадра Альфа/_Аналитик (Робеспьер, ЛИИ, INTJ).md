...
Генерируя свои социальные идеи, абстрагируется от частных обстоятельств, считая, что их можно и изменить и приспособить. В результате его идеализированные теории сталкиваются с реальными противоречиями конкретных социальных условий и часто реализуются в искаженной, иногда и извращенной форме
