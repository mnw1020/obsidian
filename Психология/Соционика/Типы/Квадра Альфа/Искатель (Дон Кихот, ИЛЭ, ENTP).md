...
Не любит включаться в работу на ее завершающем этапе — это значит быть простым исполнителем в рамках чужого проекта, а он и свои-то проекты до конца прорабатывать не любит.  
Но бывает и так, что "вписавшись" в чужой проект, сразу же начинает ощущать его "своим", и тогда у него возникает непреодолимое желание изменить всю предыдущую работу по собственному усмотрению, и он самым решительным образом на этом настаивает.

Ему бывает трудно подчиняться требованиям руководства, а в случае, если они не совпадают с его собственным мнением, не подчиняется им вообще. Склонен игнорировать фактор профессиональной дисциплины. Но в условиях жесткой дисциплины и официальности действительно работать не способен.
...
И тем не менее довольно высоко оценивает и широко рекламирует свои деловые качества.
