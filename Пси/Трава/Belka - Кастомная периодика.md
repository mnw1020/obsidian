...
# Тест системы
На первые 5 дней (раз тормоза клонов после посадки) диммер лампы установлен в режим 50% мощности те на 300w. Сама лампа поднята над растихами примерно на метр.
