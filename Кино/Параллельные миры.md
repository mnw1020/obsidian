...
Время: 43 min
Режисер:
  - "Richard Kompton (Ричард Комптон)"
  - "Devid E. Pekinpa (Дэвид Э. Пекинпа)"
  - "Jerry O'Connell (О’Коннелл, Джерри)"
  - "Reza Badiyi (Реза Бадии)"
  - "Dzhim Dzhonston (Джим Джонстон)"
Актеры:
  - "Cleavant Derricks (Кливант Деррикс)"
  - "Jerry O'Connell (О’Коннелл, Джерри)"
  - "John Rhys-Davies (Джон Рис-Дэвис)"
  - "Kari Wuhrer (Кэри Вурер)"
  - "Sabrina Lloyd (Сабрина Ллойд)"
