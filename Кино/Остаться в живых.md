...
Режисер:
  ...
  - "Stiven Uilyams (Стивен Уильямс)"
  - "Pol A. Edvards (Пол А. Эдвардс)"
  - "Tucker Gates (Такер Гейтс)"
  - "Eric Laneuville (Эрик Ланёвилль)"
Актеры:
  - "Mettyu Foks (Мэттью Фокс)"
  - "Evangeline Lilly (Эванджелин Лилли)"
  - "Josh Holloway (Джош Холлоуэй)"
  - "Terry O'Quinn (Терри О’Куинн)"
  - "Naveen Andrews (Нэвин Эндрюс)"
