...
Время: 101 min
Режисер:
  - "Alexander Nikolayevich Samokhvalov (Александр Николаевич Самохвалов)"
  - "Борис Ростов"
  - "Dmitriy Voronkov (Дмитрий Воронков)"
  - "Oleg Pogodin (Олег Погодин)"
Актеры:
  - "Igor Petrenko (Игорь Петренко)"
  - "Vladimir Yaglych (Владимир Яглыч)"
  - "Alexey Barabash (Барабаш, Алексей Игоревич)"
  - "Dmytro Stupka (Дмитрий Ступка)"
