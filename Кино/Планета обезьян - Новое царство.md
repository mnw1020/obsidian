...
Роли актеров:
  ...
  - Dar - Sara Wiseman
  - Eagle Clan - Mitchell Roach
  - Eagle Clan - Noodle Green
  - "Eagle Clan Ape #1 - Nathan Bates"
  - "Feral Human #1 - Peter Hayes"
  - "Feral Human #2 - Sheree da Costa"
  - "Feral Human #3 - Souleymane Diasse"
  - "Feral Human #4 - Olga Miller"
  - "Feral Human #5 - Dmitriy Miller"
  - "Feral Human #6 - Anastasia Miller"
  - Honored Elder - Andy McPhee
  - Korina - Dichen Lachman
  - Koro - Neil Sandilands
  - Lab Tech - Armani Pinto
  - Laika - Frances Berry
  - Lead Tech - Virginie Laverdure
  - Lightning - Ras-Samuel
  - Maurice - Karin Konoval
  - Milo (Young Ape) - Zay Domo Artist
  - Noa - Owen Teague
  - Nova / Mae - Freya Allan
  - Oda / Rust - Kaden Hartcher
  - Proximus Caesar - Kevin Durand
  - Raka - Peter Macon
  - Soona - Lydia Peckham
  - Sylva - Eka Darville
  - "Tech #1 - Markus Hamilton"
  - "Tech #2 - Benjamin Scott"
  - "Tech #3 - Michael Spudic"
  - Trevathan - William H. Macy
  - "Youngster #1 - Nina Gallas"
  - "Youngster #2 - Samuel Falé"
  - "Youngster #3 - Nirish Bhat Surambadka"
