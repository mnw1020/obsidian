...
Время: 102 min
Режисер:
  - "Jeff Tremaine (Джефф Тремейн)"
Актеры:
  - "Georgina Cates (Джорджина Кэйтс)"
  - "Greg Kharris (Грег Харрис)"
  - "Jackson Nicoll (Джексон Николл)"
  - "Johnny Knoxville (Джонни Ноксвилл)"
  - "Kamber Hejlik (Камбер Хейлик)"
