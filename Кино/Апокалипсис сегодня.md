...
Роли актеров:
  ...
  - Captain Willard - Harvey Keitel
  - Captain Willard - Martin Sheen
  - Catholic Priest - Father Elias
  - Chef - Frederic Forrest
  - Chief - Albert Hall
  - Christian de Marais (Redux and Final Cut versions only) - David Olivier
  - Civilian - Jerry Ziesmer
  - Claudine (Redux and Final Cut versions only) - Chrystel Le Pelletier
  - Clean - Laurence Fishburne
  - Clean's Mother - Hattie Bell
  - Colby - Scott Glenn
  - Colonel - Harrison Ford
  - Colonel Kurtz - Marlon Brando
  - Eagle Thrust Seven Helicopter Pilot - R. Lee Ermey
  - Extra - Jim Gaines
  - Francis de Marais (Redux and Final Cut versions only) - Roman Coppola
  - French Soldier (Redux and Final Cut versions only) - Pierre Segui
  - "French Soldier #1 (Redux and Final Cut versions only) - Henri Sadardeil"
  - "French Soldier #2 (Redux and Final Cut versions only) - Gilbert Renkens"
  - Gaston de Marais (Redux and Final Cut versions only) - Frank Villard
  - General - G.D. Spradlin
  - Gilles de Marais (Redux and Final Cut versions only) - Gian-Carlo Coppola
  - Guitarist in Band - Linn Phillips III
  - Helicopter Pilot - Dick White
  - Helicopter Skid Marine - Lonnie 'Lono' Woodley
  - Hubert de Marais (Redux and Final Cut versions only) - Christian Marquand
  ...
  - Philippe de Marais(Redux and Final Cut versions only) - Michel Pitton
  - Photo Journalist - Dennis Hopper
  - Playmate - Colleen Camp
  - Playmate - Linda Carpenter
  - Playmate of the Year - Cynthia Wood
  - Radio Operator / Soldier - Don Gordon Bell
  - Roach - Herb Rice
  - Roxanne Sarrault (Redux and Final Cut versions only) - Aurore Clément
  - Sergeant Le Fevre (Redux and Final Cut versions only) - Yvon LeSeaux
  - Soldier - Evan A. Lottman
  - Soldier - Nick Nicholson
  - Soldier - Robin Blair-Crawford
  ...
  - The Tutor (Redux and Final Cut versions only) - Robert Julian
