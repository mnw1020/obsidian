...
Время: 106 min
Режисер:
  - Andrey Zaytsev (Андрей Зайцев)
Актеры:
  - Gleb Kalyuzhny (Глеб Калюжный) - Лёша
  - Ulyana Vaskovich (Ульяна Васькович) - Вика
  - Olga Ozollapinya (Ольга Озоллапиня) - мама Лёши
  - Dmitriy Blokhin (Дмитрий Блохин) - дядя Валера
  - Irina Frolova (Ирина Фролова) - мама Вики
