...
Роли актеров:
  - Brat Viki (Vika's Brother) - Vladislav Goryachkin
  - Dron - Dmitry Barinov
  - Dyadya Valera - Dmitriy Blokhin
  - Katya - Elizaveta Makedonskaya
  - Khuligan - Eldar Kalimulin
  - Khuligan (Hooligan) - Aleksandr Kononets
  - Khuligan (Hooligan) - Aleksey Kurtsyn
  - Khuligan (Hooligan) - Sergey Gabrielyan
  - Lyosha - Gleb Kalyuzhnyy
  - Lyosha's Mother - Olga Ozollapinya
  - Mama Viki (Vika's Mother) - Irina Frolova
  - Okhrannik (Security guard) - Yuriy Kolganov
  - Papa Viki (Vika's Father) - Shandor Berkeshi
  - Politseyskiy (Policeman) - Aleksandr Boev
  - Prodavshchitsa (Saleswoman) - Sofya Uritskaya
  - Rusalka (Mermaid) - Kseniya Pakhomova
  - Stefaniya - Aleksandra Vinogradkina
  - Stepan - Viktor Prusikov
  - Tyotya Sveta (Aunt Sveta) - Anna Rud
  - Uchitel istorii (History teacher) - Maksim Palashchenko
  - Uchitel matematiki (Mathematic teacher) - Natalya Pikula
  - Vika - Ulyana Vaskovich
  - Vityok - Daniil Pikula
  - Volkov - Aleksey Filimonov
Кинопоиск ID: "781432"
---
