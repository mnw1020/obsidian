...
Режисер:
  ...
  - "Phil Abraham (Фил Абрахам)"
  - "Michael Trim (Майкл Трим)"
  - "Constantine Makris (Константин Макрис)"
  - "Mark A. Burley (Марк А. Берли)"
Актеры:
  - "Taylor Schilling (Тейлор Шиллинг)"
  - "Kate Mulgrew (Кейт Малгрю)"
  - "Uzo Aduba (Узо Адуба)"
  - "Danielle Brooks (Даниэль Брукс)"
  - "Dascha Polanco (Даша Поланко)"
