...
Время: 94 min
Режисер:
  - "Michael Davis (Майкл Дэвис)"
Актеры:
  - "Jonathan Tucker (Джонатан Такер)"
  - "Emmanuelle Chriqui (Эммануэль Шрики)"
  - "James DeBello (Джеймс ДеБелло)"
  - "Katherine Heigl (Кэтрин Хейгл)"
  - "Larisa Oleynik (Лариса Олейник)"
