...
Время: 112 min
Режисер:
  - "Felix Fuchssteiner (Феликс Фуксштайнер)"
  - "Katharina Schöde (Катарина Шёде)"
Актеры:
  - "Kostja Ullmann (Костя Улльман)"
  - "Josefine Preuß (Йозефина Пройсс)"
  - "Maria Ehrich (Мария Эрих)"
  - "Jannis Niewöhner (Яннис Нивёнер)"
  - "Lion Wasczyk (Лион Вазчик)"
