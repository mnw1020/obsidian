...
Время: 60 min
Режисер:
  - Dzheyms Strong (Джеймс Стронг)
  - Frederik I.O. Tua (Фредерик И.О. Туа)
  - John David Coles (Джон Дэвид Коулз)
  - James Franco (Джеймс Франко)
  - Dzheyms Kent (Джеймс Кент)
Актеры:
  - James Franco (Джеймс Франко) - Jake Epping
  - Sarah Gadon (Сара Гадон) - Sadie Dunhill
  - George MacKay (Джордж Маккэй) - Bill Turcotte
  - Chris Cooper (Крис Купер) - Al Templeton
  - Cherry Jones (Черри Джонс) - Marguerite Oswald
