...
Время: 105 min
Режисер:
  - "Louis Bélanger (Луис Беланже)"
Актеры:
  - "Alexis Martin (Алексис Мартен)"
  - "Emmanuelle Lussier Martinez (Эммануэль Люссье Мартинес)"
  - "Gary Boudreault (Гари Бодро)"
  - "Gilles Renaud (Жиль Рено)"
  - "Mimi Côté (Мими Котэ)"
