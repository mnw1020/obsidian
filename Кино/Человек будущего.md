...
Время: 30 min
Режисер:
  - "Dzhonatan Uotson (Джонатан Уотсон)"
  - "Maykl Uiver (Майкл Уивер)"
  - "Evan Goldberg (Эван Голдберг)"
  - "Seth Rogen (Сет Роген)"
  - "Aleksandr Buono (Александр Буоно)"
Актеры:
  - "Josh Hutcherson (Джош Хатчерсон)"
  - "Eliza Coupe (Элиза Куп)"
  - "Derek Wilson (Дерек Уилсон)"
