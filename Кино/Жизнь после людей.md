...
Время: 43 min
Режисер:
  - "Geoff Marshall (Джофф Маршалл)"
  - "Jim Hense (Джим Хенс)"
  - "Douglas Cohen (Дуглас Коэн)"
  - "Frank Kosa (Фрэнк Коза)"
  - "Louis Tarantino (Луис Тарантино)"
Актеры:
  - "Andrew Patrick Nelson (Эндрю Патрик Нельсон)"
  - "Daniel K. Riskin (Дэн Рискин)"
  - "James Lurie (Джеймс Лури)"
  - "Paul M. Sutter (Пол Саттер)"
  - "Steven S. Ross (Стивен С. Росс)"
