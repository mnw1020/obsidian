...
Время: 94 min
Режисер:
  - "Andrzej Sekuła (Анджей Секула)"
Актеры:
  - "Geraint Wyn Davies (Джерент Уин Дэйвис)"
  - "Grace Lynn Kung (Грэйс Линн Кунг)"
  - "Kari Matchett (Кари Матчетт)"
  - "Matthew Ferguson (Мэттью Фергюсон)"
  - "Neil Crone (Нил Кроун)"
