...
Режисер:
  ...
  - "Henry J. Bronchtein (Генри Брончтейн)"
  - "Félix Enríquez Alcalá (Феликс Энрикес Алькала)"
  - "Frederick King Keller (Фредерик Кинг Келлер)"
  - "Lesli Libman (Лесли Либман)"
Актеры:
  - "Dominic Purcell (Доминик Перселл)"
  - "Dzhon Marshall Dzhons (Джон Маршалл Джонс)"
  - "Jayne Brook (Джейн Брук)"
  - "William Forsythe (Уильям Форсайт)"
  - "Sprague Grayden (Спрэг Грэйден)"
