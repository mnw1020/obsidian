...
Время: 22 min
Режисер:
  - "Mikel B. Anderson (Микель Б. Андерсон)"
  - "Jim Reardon (Джим Рирдон)"
  - "Mark Kirkland (Марк Керклэнд)"
  - "Stiven Din Mur (Стивен Дин Мур)"
  - "Devid Silverman (Дэвид Силверман)"
Актеры:
  - "Dan Castellaneta (Дэн Кастелланета)"
  - "Harry Shearer (Гарри Ширер)"
  - "Julie Kavner (Джули Кавнер)"
  - "Nancy Cartwright (Нэнси Картрайт)"
  - "Yeardley Smith (Ярдли Смит)"
