...
Время: 100 min
Режисер:
  - "Charlotte de Turckheim (Шарлотт де Тюркейм)"
Актеры:
  - "Victoria Abril (Виктория Абриль)"
  - "Lola Dewaere (Лола Девэр)"
  - "Catherine Hosmalin (Катрин Осмален)"
  - "Grégory Fitoussi (Грегори Фетусси)"
  - "Mehdi Nebbou (Мехди Неббу)"
