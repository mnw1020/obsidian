...
Время: 50 min
Режисер:
  - "Yury Kuzmenko (Юрий Кузьменко)"
  - "Georgiy Nikolaenko (Георгий Михайлович Николаенко)"
Актеры:
  - "Vladimir Gostyukhin (Владимир Гостюхин)"
  - "Vladislav Galkin (Владислав Галкин)"
  - "Natalya Egorova (Наталья Егорова)"
  - "Vadim Yatsuk (Вадим Яцук)"
  - "Viktor Yatsuk (Виктор Яцук)"
