...
Актеры:
  - "Ine Marie Wilmann (Ине Марие Вильман)"
  - "Kim Falck (Ким Фальк)"
  - "Mads Sjøgård Pettersen (Мадс Сьёгор Петтерсен)"
  - "Gard B. Eidsvold (Гар Б. Эйдсвольд)"
  - "Anneke von der Lippe (Аннеке фон дер Липпе)"
