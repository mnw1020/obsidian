...
Время: 113 min
Режисер:
  - "Eric Bress (Эрик Бресс)"
  - "J. Mackye Gruber (Дж. Макки Грубер)"
Актеры:
  - "Amy Smart (Эми Смарт)"
  - "Ashton Kutcher (Эштон Кутчер)"
  - "Elden Henson (Элден Хенсон)"
  - "John Patrick Amedori (Джон Патрик Амедори)"
  - "William Lee Scott (Уильям Ли Скотт)"
