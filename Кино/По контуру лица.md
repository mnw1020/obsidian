...
Режисер:
  - "Pavel Mak (Павел Мак)"
Актеры:
  - "Aleksandr Grishayev (Гришаев, Александр Юрьевич)"
  - "Alexey Nilov (Алексей Геннадьевич Нилов)"
  - "Dmitry Meskhiev (Дмитрий Месхиев)"
  - "Ernest Timerkhanov (Эрнест Тимерханов)"
  - "Karina Razumovskaya (Карина Разумовская)"
