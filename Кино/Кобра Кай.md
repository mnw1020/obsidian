...
Режисер:
  ...
  - "Hayden Schlossberg (Хейден Шлоссберг)"
  - "Joel Novoa (Джоэль Новоа)"
  - "Dzhosh Khild (Джош Хилд)"
  - "Jennifer Celotta (Дженнифер Челотта)"
Актеры:
  - "Mary Mouser (Мэри Маусер)"
  - "Ralph Macchio (Ральф Маччио)"
  - "Tanner Buchanan (Тэннер Бьюкэнэн)"
  - "William Zabka (Уильям Забка)"
  - "Xolo Maridueña (Шоло Маридуэнья)"
