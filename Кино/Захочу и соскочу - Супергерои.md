...
Время: 102 min
Режисер:
  - "Sydney Sibilia (Сидней Сибилиа)"
Актеры:
  - "Edoardo Leo (Эдоардо Лео)"
  - "Libero De Rienzo (Либеро Де Риенцо)"
  - "Paolo Calabresi (Паоло Калабрези)"
  - "Stefano Fresi (Стефано Фрези)"
  - "Valerio Aprea (Валерио Апреа)"
