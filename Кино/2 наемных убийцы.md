...
Время: 86 min
Режисер:
  - "Brett Scott Ermilio (Бретт Скотт Эрмилио)"
Актеры:
  - "Chris Ferrarini (Крис Феррарини)"
  - "Ernie Sloman (Эрни Сломан)"
  - "Cary Y. Mizobe (Кэри И. Мидзобэ)"
  - "Mitch Yapko (Митч Япко)"
  - "Victor Jaco (Виктор Александр Яко)"
