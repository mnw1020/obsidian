...
Режисер:
  ...
  - "Rick Jacobson (Рик Джейкобсон)"
  - "Tony Tilse (Тони Тилс)"
  - "MJ Bassett (М. Дж. Бассетт)"
  - "David Frazee (Дэвид Фрэйзи)"
Актеры:
  - "Bruce Campbell (Брюс Кэмпбелл)"
  - "Dana DeLorenzo (Дэна ДеЛоренцо)"
  - "Jill Marie Jones (Джилл Мари Джонс)"
  - "Lucy Lawless (Люси Лоулесс)"
  - "Ray Santiago (Рэй Сантьяго)"
