...
Режисер:
  ...
  - "Sergey Arlanov (Сергей Арланов)"
Актеры:
  - "Igor Petrenko (Игорь Петренко)"
  - "Paulina Andreyeva (Паулина Андреева)"
  - "Dmitriy Ulyanov (Дмитрий Ульянов)"
  - "Semyon Shkalikov (Семён Шкаликов)"
  - "Nikita Pavlenko (Никита Павленко)"
