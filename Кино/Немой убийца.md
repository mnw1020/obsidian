...
Время: 90 min
Режисер:
  - "Kelly Sandefur (Келли Сэндфер)"
Актеры:
  - "Joe Lando (Джо Ландо)"
  - "Gabrielle Carteris (Гэбриэлль Картерис)"
  - "Michael Gross (Майкл Гросс)"
  - "Michael Gregory (Майкл Грегори)"
  - "Carlos Alazraqui (Карлос Аласраки)"
