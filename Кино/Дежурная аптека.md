...
Время: 25 min
Режисер:
  - "Antonio Mercero (Антонио Мерсеро)"
  - "Antonio Conesa (Антонио Конеса)"
  - "Vicente Escrivá (Висенте Эскрива)"
Актеры:
  - "Carlos Larrañaga (Карлос Ларраньяга)"
  - "Cesáreo Estébanez (Сесарео Эстебанес)"
  - "Concha Cuetos (Конча Куэтос)"
  - "Julián González (Хулиан Гонсалес)"
  - "Miguel Ángel Garzón (Мигель Анхель Гарсон)"
