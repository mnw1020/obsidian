...
Время: 93 min
Режисер:
  - "Robert Thalheim (Роберт Тальхайм)"
Актеры:
  - "Henry Hübchen (Хенри Хюбхен)"
  - "Antje Traue (Антье Трауэ)"
  - "Michael Gwisdek (Михаэль Гвиздек)"
  - "Thomas Thieme (Томас Тиме)"
  - "Winfried Glatzeder (Винфрид Глатцедер)"
