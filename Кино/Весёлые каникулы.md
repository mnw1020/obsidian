...
Время: 96 min
Режисер:
  - "Adrian Grünberg (Адриан Грюнберг)"
Актеры:
  - "Mel Gibson (Мэл Гибсон)"
  - "Kevin Ernandes (Кевин Эрнандес)"
  - "Dolores Heredia (Долорес Эредия)"
  - "Jesús Ochoa (Хесус Очоа)"
  - "Daniel Giménez Cacho (Даниэль Хименес Качо)"
