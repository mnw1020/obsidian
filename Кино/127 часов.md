...
Актеры:
  - James Franco (Джеймс Франко) - Aron Ralston
  - Kate Mara (Кейт Мара) - Kristi
  - Amber Tamblyn (Эмбер Тэмблин) - Megan
  - Clémence Poésy (Клеманс Поэзи) - Rana
  - Lizzy Caplan (Лиззи Каплан) - Sonja
