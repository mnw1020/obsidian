...
Режисер:
  - "Din Uayt (Дин Уайт)"
  - "Ed Fraiman (Эд Фрэйман)"
  - "P.Dzh. Peshe (П.Дж. Пеше)"
  - "Mairzee Almas (Майрзи Алмас)"
  - "Omar Madha (Омар Мадха)"
Актеры:
  - "Bob Morley (Боб Морли)"
  - "Eliza Taylor (Элайза Тейлор)"
  - "Lindsey Morgan (Линдси Морган)"
  - "Marie Avgeropoulos (Мари Авгеропулос)"
  - "Thomas McDonell (Томас МакДонелл)"
