...
Актеры:
  - Henry Cavill (Генри Кавилл) - Solo
  - Armie Hammer (Арми Хаммер) - Illya
  - Alicia Vikander (Алисия Викандер) - Gaby
  - Elizabeth Debicki (Элизабет Дебики) - Victoria
  - Hugh Grant (Хью Грант) - Waverly
