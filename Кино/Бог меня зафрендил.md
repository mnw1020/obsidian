...
Режисер:
  ...
  - "Darren Grant (Даррен Грант)"
  - "Joe Morton (Джо Мортон)"
  - "Viktor Nelli Ml. (Виктор Нелли мл.)"
  - "Gregori Smit (Грегори Смит)"
Актеры:
  - "Brandon Micheal Hall (Брэндон Майкл Холл)"
  - "Violett Beane (Вайолетт Бин)"
  - "Suraj Sharma (Сурадж Шарма)"
  - "Javicia Leslie (Джавиша Лесли)"
  - "Joe Morton (Джо Мортон)"
