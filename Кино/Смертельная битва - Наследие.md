...
Время: 12 min
Режисер:
  - "Kevin Tancharoen (Кевин Танчароэн)"
Актеры:
  - "Casper Van Dien (Каспер Ван Дин)"
  - "Ian Anthony Dale (Иэн Энтони Дэйл)"
  - "Samantha Win (Саманта Уин)"
  - "Kim Do Nguyen (Ким До Нгуен)"
  - "Johnson Phan (Джонсон Фэн)"
