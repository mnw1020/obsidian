...
Актеры:
  - "Sergei Kupriianov (Сергей Куприянов)"
  - "Aleksey Buldakov (Алексей Булдаков)"
  - "Taras Denisenko (Тарас Денисенко)"
  - "Vasiliy Domrachyov (Домрачёв, Василий Валерианович)"
  - "Andrey Zertsalov (Андрей Зерцалов)"
