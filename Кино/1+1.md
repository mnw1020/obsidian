...
Время: 112 min
Режисер:
  - Olivier Nakache (Оливье Накаш)
  - Éric Toledano (Эрик Толедано)
Актеры:
  - François Cluzet (Франсуа Клюзе)
  - Omar Sy (Омар Си)
  - Audrey Fleurot (Одри Флёро)
  - Anne Le Ny (Анн Ле Ни)
  - Joséphine de Meaux (Жозефин де Мо)
