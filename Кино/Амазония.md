...
Режисер:
  ...
  - "Terry Ingram (Терри Ингрэм)"
  - "Ron Oliver (Рон Оливер)"
  - "John Bell (Джон Белл)"
  - "Ross Clyde (Росс Клайд)"
Актеры:
  - "C. Thomas Howell (Кристофер Томас Хауэлл)"
  - "Carol Alt (Кэрол Олт)"
  - "Chris William Martin (Крис Мартин)"
  - "Fabiana Udenio (Фабиана Уденио)"
  - "Tyler Hynes (Тайлер Хайнс)"
