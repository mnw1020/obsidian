...
Время: 136 min
Режисер:
  - "Vadim Shmelyov (Вадим Шмелев)"
Актеры:
  - "Artyom Gubin (Артём Губин)"
  - "Igor Yudin (Игорь Юдин)"
  - "Lyubov Konstantinova (Любовь Константинова)"
  - "Alexey Bardukov (Алексей Игоревич Бардуков)"
  - "Yevgeny Dyatlov (Дятлов, Евгений Валерьевич)"
