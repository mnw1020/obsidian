...
Время: 94 min
Режисер:
  - "Colin Strause (Колин Штраус)"
  - "Greg Strause (Грег Штраус)"
Актеры:
  - "Eric Balfour (Эрик Бальфур)"
  - "Scottie Thompson (Скотти Томпсон)"
  - "David Zayas (Дэвид Зейес)"
  - "Brittany Daniel (Бриттани Дэниел)"
  - "Donald Faison (Дональд Фэйсон)"
