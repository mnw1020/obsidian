...
Время: 90 min
Режисер:
  - "Holger Haase (Хольгер Хаазе)"
Актеры:
  - "Anna Kubin (Анна Кубин)"
  - "Bettina Lamprecht (Беттина Лампрехт)"
  - "Martina Hill (Мартина Хилл)"
  - "Oliver Bootz (Оливер Бооц)"
  - "Vera Baranyai (Вера Бараньяи)"
