...
Время: 100 min
Режисер:
  - "Galder Gaztelu-Urrutia (Гальдер Гастелу-Уррутия)"
Актеры:
  - "Milena Smit (Милена Смит)"
  - "Hovik Keuchkerian (Ховик Кеучкерян)"
  - "Natalia Tena (Наталия Тена)"
  - "Óscar Jaenada (Оскар Хаэнада)"
  - "Bastien Ughetto (Бастьен Угетто)"
