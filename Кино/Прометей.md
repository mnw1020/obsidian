...
Роли актеров:
  ...
  - Automated Voice (Amharic) - Berhane Woldegabriel
  - Automated Voice (Czech) - Zed Sevcikova
  - Automated Voice (Greek) - Charalambos Dendrinos
  - Automated Voice (Icelandic) - Reynir Thor Eggertsson
  - Automated Voice (Japanese) - Shin-Ichiro Okajima
  - Automated Voice (Swahili) - Wambui Wa-Ngatho
  - Automated Voice (Thai) - Wannaporn Rienjang
  - Automated Voice (Tibetan) - Sonam Dugdak
  - Chance - Emun Elliott
  - Charlie Holloway - Logan Marshall-Green
  - David - Michael Fassbender
  - Elder Engineer - Matt Rook
  - Elephantine Engineer - Arnold Montey
  - Elephantine Engineer - Phill Martin
