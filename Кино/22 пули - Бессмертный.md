...
Время: 117 min
Режисер:
  - Rishar Berri (Ришар Берри)
Актеры:
  - Jean Reno (Жан Рено) - Charly Matteï
  - Kad Merad (Кад Мерад) - Tony Zacchia
  - Jean-Pierre Darroussin (Жан-Пьер Дарруссен) - Martin Beaudinard
  - Marina Foïs (Марина Фоис) - Marie Goldman
  - "JoeyStarr (Джои Старр) - Le pistachier (в титрах: Joey Starr)"
