...
Время: 71 min
Режисер:
  - "Anatoly Eiramdzhan (Анатолий Эйрамджан)"
Актеры:
  - "Aleksandr Abdulov (Александр Гаврилович Абдулов)"
  - "Aleksandr Pankratov-Chyornyy (Александр Панкратов-Чёрный)"
  - "Irina Rozanova (Ирина Розанова)"
  - "Irina Shmelyova (Ирина Шмелева)"
  - "Yelena Tsyplakova (Цыплакова, Елена Октябревна)"
