...
Время: 98 min
Режисер:
  - Ric Roman Waugh (Ric Roman Waugh (Рик Роман Во))
Актеры:
  - Gerard Butler (Gerard Butler (Джерард Батлер))
  - Morena Baccarin (Morena Baccarin (Морена Баккарин))
  - Roman Griffin Davis (Roman Griffin Davis (Роман Гриффин Дэвис))
