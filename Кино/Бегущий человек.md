...
Время: 101 min
Режисер:
  - "Paul Michael Glaser (Пол Майкл Глейзер)"
Актеры:
  - "Arnold Schwarzenegger (Арнольд Шварценеггер)"
  - "Richard Dawson (Ричард Доусон)"
  - "María Conchita Alonso (Мария Кончита Алонсо)"
  - "Yaphet Kotto (Яфет Котто)"
  - "Gus Rethwisch (Гас Ретвиш)"
