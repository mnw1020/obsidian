...
Время: 52 min
Режисер:
  - "Kim Chapiron (Ким Шапирон)"
  - "Jérôme Cornuau (Жером Корнюо)"
  - "Philippe Triboit (Филипп Трибуа)"
  - "Julien Despaux (Жульен Депо)"
  - "Olivier Panchot (Оливье Паншо)"
Актеры:
  - "Mathieu Spinosi (Мэтью Спинози)"
  - "Olivier Rabourdin (Оливье Рабурден)"
  - "Anne Suarez (Анна Суарес)"
  - "Flora Bonfanti (Флора Бонфанти)"
  - "Santos Cardoso Rubens (Сантос Кардосо Рубенс)"
