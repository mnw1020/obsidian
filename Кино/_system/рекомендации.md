...
async function main(){
    ...
    const draw=()=>{
        const visible=combineRecommendationLists(all,mlCheckbox.checked?mlRows:[],checkbox.checked);
        ...
        setProgress(ui,`${seeds.diag} · показано ${visible.length} · просмотренных ${hidden}. MovieLens ${mlStatus}.`,100);
