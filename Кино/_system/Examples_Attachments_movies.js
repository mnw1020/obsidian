 ...
 * IMDb задаёт имена и роли; КП дополняет отсутствующих людей и пустые роли.
 * Имена унифицируются по общей таблице вариантов. Имена в YAML всегда латиницей;
...
function mergedPeople(peopleSources, field) {
    return mergeCreditSources(peopleSources, field).map(person => sourcePersonValue(person, field))
        .sort(comparePeopleValues);
}
