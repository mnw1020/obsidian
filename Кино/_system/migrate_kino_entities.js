...
,
  {
  "id": "kinoteka-person-update-v1",
  "name": "Кино - Обновить имена",
  "type": "Macro",
  "command": true,
  "runOnStartup": false,
  "macro": {
    "id": "kinoteka-person-update-macro-v1",
    "name": "Кино - Обновить имена",
    "commands": [
      {
        "id": "kinoteka-person-update-script-v1",
        "name": "update_kino_persons",
        "type": "UserScript",
        "path": "скрипты/update_kino_persons.js",
        "settings": {}
      }
    ]
  }
