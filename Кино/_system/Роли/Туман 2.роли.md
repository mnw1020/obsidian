...
Кинопоиск ID: ""
Жанр: ["Sci-Fi","Drama"]
Режисер: ["Ivan Shurkhovetskiy (Иван Шурховецкий)"]
Актеры: ["Aleksey Markov (Алексей Марков)","Artyom Krestnikov (Артем Крестников)","Dmitry Sergin (Дмитрий Львович Сергин)","Hryhorii Kalinin (Григорий Калинин)","Ivan Lapin (Иван Лапин)"]
Роли актеров: []
---
