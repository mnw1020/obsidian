...
Кинопоиск ID: ""
Жанр: ["Drama","History"]
Режисер: ["Carl Leblanc"]
Актеры: ["Arved Birnbaum (Арвед Бирнбаум)","Fridkhelm Gertner (Фридхельм Гертнер)","Maksimilian Gertner (Максимилиан Гэртнер)","Steffen Mennekes (Штеффен Меннекес)","Uwe Boll (Уве Болл)"]
Роли актеров: []
---
