...
Время: 97 min
Режисер:
  - "Vera Storozheva (Сторожева, Вера Михайловна)"
Актеры:
  - "Artur Smolyaninov (Артур Сергеевич Смольянинов)"
  - "Anna Starshenbaum (Анна Старшенбаум)"
  - "Olga Gnedich (Ольга Гнедич)"
  - "Sergei Puskepalis (Сергей Пускепалис)"
  - "Yekaterina Vulichenko (Екатерина Владимировна Вуличенко)"
