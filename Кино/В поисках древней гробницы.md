...
Время: 182 min
Режисер:
  - "Sebastian Niemann (Себастьян Ниман)"
Актеры:
  - "Matthias Koeberlin (Матиас Кеберлин)"
  - "Naike Rivelli (Найке Ривелли)"
  - "Manou Lubowski (Ману Любовски)"
  - "Hans Diehl (Ханс Диль)"
  - "Dietrich Hollinderbäumer (Дитрих Холлиндербаумер)"
