...
Время: 79 min
Режисер:
  - "Chris Kentis (Крис Кентис)"
Актеры:
  - "Blanchard Ryan (Блэнчард Райан)"
  - "Daniel Travis (Дэниэл Трэвис)"
  - "Saul Stein (Сол Стайн)"
  - "Michael E. Williamson (Майкл Э. Уильямсон)"
  - "Cristina Zenato (Кристина Зенарро)"
