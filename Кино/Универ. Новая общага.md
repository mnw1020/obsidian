...
Режисер:
  ...
  - "Maksim Zykov (Максим Зыков)"
  - "Shota Gamisoniya (Шота Гамисония)"
  - "Rustam Mosafir (Рустам Мосафир)"
  - "Konstantin Kolesov (Константин Колесов)"
Актеры:
  - "Ararat Keshyan (Арарат Кещян)"
  - "Hanna Kuzina (Анна Кузина)"
  - "Nastasya Samburskaya (Настасья Самбурская)"
  - "Stanislav Yarushin (Станислав Ярушин)"
