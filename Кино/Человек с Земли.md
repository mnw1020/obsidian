...
Время: 87 min
Режисер:
  - "Richard Schenkman (Ричард Шенкман)"
Актеры:
  - "Annika Peterson (Анника Петерсон)"
  - "David Lee Smith (Дэвид Ли Смит)"
  - "Ellen Crawford (Эллен Кроуфорд)"
  - "John Billingsley (Джон Биллингсли)"
  - "Tony Todd (Тони Тодд)"
