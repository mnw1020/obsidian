...
Время: 85 min
Режисер:
  - "Fabrice Genestal (Фабрис Женесталь)"
Актеры:
  - "Charles Berling (Шарль Берлен)"
  - "Gilles Lellouche (Жиль Леллуш)"
  - "Kamar Abbas (Камар Аббас)"
  - "Vahina Giocante (Ваина Джоканте)"
  - "Zhoffre Verbryuggen (Жоффре Вербрюгген)"
