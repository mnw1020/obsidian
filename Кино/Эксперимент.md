...
Время: 120 min
Режисер:
  - "Oliver Hirschbiegel (Оливер Хиршбигель)"
Актеры:
  - "Moritz Bleibtreu (Мориц Бляйбтрой)"
  - "Christian Berkel (Кристиан Беркель)"
  - "Oliver Stokowski (Оливер Штоковски)"
  - "Justus von Dohnányi (Юстус фон Донаньи)"
  - "Timo Dierkes (Тимо Диркес)"
