...
Время: 105 min
Режисер:
  - "Stéphane Robelin (Стефан Робели)"
Актеры:
  - "Fanny Valette (Фанни Валетт)"
  - "Pierre Richard (Пьер Ришар)"
  - "Stéphane Bissot (Стефан Биссо)"
  - "Stéphanie Crayencour (Стефани де Крэенкур)"
  - "Yaniss Lespert (Яннис Леспер)"
