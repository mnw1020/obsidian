...
Время: 101 min
Режисер:
  - Patrick Alessandrin (Патрик Алессандрен)
Актеры:
  - Cyril Raffaelli (Сирил Раффаэлли) - Capt. Damien Tomaso
  - David Belle (Давид Белль) - Leïto
  - Philippe Torreton (Филипп Торретон) - Le président de la République
  - Daniel Duval (Даниэль Дюваль) - Walter Gassman
  - Elodie Yung (Элоди Юнг) - Tao
