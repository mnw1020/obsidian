...
Время: 89 min
Режисер:
  - "Kresten Vestbjerg Andersen (Крестен Вестбьерг Андерсен)"
  - "Thorbjørn Christoffersen (Торбьорн Кристофферсен)"
  - "Philip Einstein Lipski (Филип Эйнштейн Липски)"
Актеры:
  - "Anders Juul (Андерс Юул)"
  - "Brian Lykke (Брайан Лукке)"
  - "Hadi Ka-Koush (Хади Ка-Куш)"
  - "Lars Mikkelsen (Ларс Миккельсен)"
  - "Lerke Vinter Andersen (Лерке Винтер Андерсен)"
