...
Время: 113 min
Режисер:
  - "Julia Loktev (Джулия Локтев)"
Актеры:
  - "Bidzina Gujabidze (Бидзина Гуджабидзе)"
  - "Gael García Bernal (Гаэль Гарсиа Берналь)"
  - "Hani Furstenberg (Хани Фюрстенберг)"
  - "Tako Pitskhelauri (Тако Питахелаури)"
  - "Tali Pitakhelauri (Тали Питахелаури)"
