...
Режисер:
  ...
  - "Terrence O'Hara (Терренс О’Хара)"
  - "Chuck Bowman (Чак Боуман)"
  - "Rodney Charters (Родни Чартерс)"
Актеры:
  - "Andrea Parker (Андреа Паркер)"
  - "Jon Gries (Джон Грайз)"
  - "Michael T. Weiss (Майкл Т. Уайсс)"
  - "Patrick Bauchau (Патрик Бошо)"
  - "Ryan Merriman (Райан Мерриман)"
