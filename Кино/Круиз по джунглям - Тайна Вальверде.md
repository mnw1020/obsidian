...
Время: 102 min
Режисер:
  - "Malik Bentalha (Малик Бенталья)"
  - "Ludovic Colbeau-Justin (Людовик Кольбо-Жюстен)"
Актеры:
  - "Malik Bentalha (Малик Бенталья)"
  - "Joséphine Japy (Жозефин Жапи)"
  - "Jérôme Commandeur (Жером Коммандёр)"
  - "François Damiens (Франсуа Дамиенс)"
  - "Benoît Magimel (Бенуа Мажимель)"
