...
Время: 43 min
Режисер:
  - "Brannon Braga (Брэннон Брага)"
  - "Ann Druyan (Энн Драйэн)"
  - "Bill Pope (Билл Поуп)"
  - "Kevin Dart (Кевин Дарт)"
Актеры:
  - "Christopher Emerson (Крис Эмерсон)"
  - "Keythe Farley (Кит Фарли)"
  - "Piotr Michael (Петр Майкл)"
  - "Enn Reitel (Энн Рейтел)"
  - "Piter Emshviller (Питер Эмшвиллер)"
