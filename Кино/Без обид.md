...
Время: 103 min
Режисер:
  - "Dzhin Stupnitski (Джин Ступницки)"
Актеры:
  - "Jennifer Lawrence (Дженнифер Лоуренс)"
  - "Andrew Barth Feldman (Эндрю Барт Фельдман)"
  - "Laura Benanti (Лаура Бенанти)"
  - "Matthew Broderick (Мэттью Бродерик)"
  - "Natalie Morales (Натали Моралес)"
