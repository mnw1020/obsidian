...
Время: 96 min
Режисер:
  - "Eric Bross (Эрик Бросс)"
  - "Mikael Salomon (Микаэл Саломон)"
Актеры:
  - "Indiana Evans (Индиана Эванс)"
  - "Brenton Tueyts (Брентон Туэйтс)"
  - "Denise Richards (Дениз Ричардс)"
  - "Patrick St. Esprit (Патрик Ст. Эсприт)"
  - "Frank John Hughes (Фрэнк Джон Хьюз)"
