...
Актеры:
  - "George Newbern (Джордж Ньюберн)"
  - "Isaac Durnford (Исаак Дернфорд)"
  - "Louise Fletcher (Луиза Флетчер)"
  - "Maxwell Perry Cotton (Максвелл Перри Коттон)"
  - "Robert Wagner (Роберт Вагнер)"
