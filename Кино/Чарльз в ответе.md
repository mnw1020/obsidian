...
Режисер:
  ...
  - "Alan Rafkin (Алан Рефкин)"
  - "Zane Buzby (Зейн Базби)"
  - "Bob Klaver (Боб Клавер)"
Актеры:
  - "Scott Baio (Скотт Байо)"
  - "Willie Aames (Вилли Эймс)"
  - "Nicole Eggert (Николь Эггерт)"
  - "Josie Davis (Джози Дэвис)"
  - "Alexander Polinsky (Александр Полински)"
