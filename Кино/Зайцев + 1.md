...
Режисер:
  ...
  - "Vsevolod Brodskiy (Всеволод Бродский)"
  - "Mike Starchak (Михаил Старчак)"
Актеры:
  - "Filipp Kotov (Котов, Филипп Юрьевич)"
  - "Mikhail Galustyan (Михаил Сергеевич Галустян)"
  - "Ivan Gromov (Иван Громов)"
  - "Nataliya Kosteneva (Наталья Владимировна Костенёва)"
  - "Alexander Soldatkin (Александр Солдаткин)"
