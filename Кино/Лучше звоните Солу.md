...
Режисер:
  ...
  - "Thomas Schnauz (Томас Шнауц)"
  - "Peter Gould (Питер Гулд)"
  - "Michael Morris (Майкл Моррис)"
  - "Adam Bernstein (Адам Бернштейн)"
Актеры:
  - "Bob Odenkirk (Боб Оденкёрк)"
  - "Jonathan Banks (Джонатан Бэнкс)"
  - "Michael Mando (Майкл Мэндо)"
  - "Patrick Fabian (Патрик Фабиан)"
