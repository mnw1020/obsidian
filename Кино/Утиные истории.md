...
Время: 22 min
Режисер:
  - "Bob Hathcock (Боб Хэчкок)"
  - "James T. Walker (Джеймс Т. Уолкер)"
  - "Alan Zaslove (Алан Заслов)"
  - "Terence Harrison (Теренс Харрисон)"
  - "Steve Clark (Стив Кларк)"
Актеры:
  - "Alan Young (Алан Янг)"
  - "Russi Taylor (Расси Тейлор)"
  - "Chuck McCann (Чак МакКанн)"
  - "Terry McGovern (Теренс МакГоверн)"
  - "Frank Welker (Фрэнк Уэлкер)"
