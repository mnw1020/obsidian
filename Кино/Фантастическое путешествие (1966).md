...
Время: 100 min
Режисер:
  - "Richard Fleischer (Ричард Флейшер)"
Актеры:
  - "Stephen Boyd (Стивен Бойд)"
  - "Raquel Welch (Ракель Уэлч)"
  - "Edmond O'Brien (О’Брайен, Эдмонд)"
  - "Donald Pleasence (Дональд Плезенс)"
  - "Arthur O'Connell (О’Коннелл, Артур)"
