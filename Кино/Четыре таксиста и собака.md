...
Время: 99 min
Режисер:
  - "Fyodor Popov (Федор Максимович Попов)"
Актеры:
  - "Viktor Bychkov (Виктор Николаевич Бычков)"
  - "Anatoliy Goryachev (Анатолий Горячев)"
  - "Aleksey Panin (Алексей Панин)"
  - "Lyubov Zaytseva (Любовь Зайцева)"
  - "Andrey Fedortsov (Андрей Федорцов)"
