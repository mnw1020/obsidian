...
Время: 14 min
Режисер:
  - "Aleksandr Lyutkevich (Александр Люткевич)"
  - "Yury Butyrin (Юрий Бутырин)"
  - "Andrey Ignatenko (Игнатенко, Андрей Борисович)"
Актеры:
  - "Venera Rakhimova (Венера Рахимова)"
  - "Kristina Orbakaitė (Кристина Орбакайте)"
  - "Svetlana Stepchenko (Светлана Борисовна Степченко)"
  - "Aleksey Borzunov (Борзунов, Алексей Алексеевич)"
  - "Klara Rumyanova (Клара Румянова)"
