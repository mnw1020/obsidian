...
Режисер:
  ...
  - "Lev L. Spiro (Лев Л. Спиро)"
Актеры:
  - "Josefine Preuß (Йозефина Пройсс)"
  - "Florian Bartholomäi (Флориан Бартоломай)"
  - "Karl Walter Sprungala (Карл Вальтер Шпрунгала)"
  - "Peter Simonischek (Петер Симонишек)"
  - "Pierre Kiwitt (Пьер Кивитт)"
