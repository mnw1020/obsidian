...
Время: 55 min
Режисер:
  - "Kasper Barfoed (Каспер Барфоэд)"
  - "Mikkel Serup (Миккел Серуп)"
  - "Milad Alami (Милад Алами)"
  - "Roni Ezra (Рони Эзра)"
Актеры:
  - "Anders Hove (Андерс Хове)"
  - "Danica Curcic (Даница Чурчич)"
  - "Iben Dorner Estergor (Ибен Дорнер Эстергор)"
  - "Mikkel Boe Fyolsgor (Миккель Боэ Фёльсгор)"
  - "Sofi Grobyol (Софи Гробёль)"
