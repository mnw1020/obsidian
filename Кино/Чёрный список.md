...
Время: 43 min
Режисер:
  - "Andrew McCarthy (Эндрю Маккарти)"
  - "Michael W. Watkins (Майкл В. Уоткинс)"
  - "Bill Rou (Билл Роу)"
  - "Maykl Karachchiolo (Майкл Караччиоло)"
  - "John Terlesky (Джон Терлески)"
Актеры:
  - "James Spader (Джеймс Спейдер)"
  - "Megan Boone (Меган Бун)"
  - "Diego Klattenhoff (Диего Клаттенхофф)"
  - "Harry Lennix (Гарри Ленникс)"
  - "Hisham Tawfiq (Хишам Тафик)"
