...
Роли актеров:
  - Armed Police - Cris Haris
  - Beautiful Tourist - Lele Dai
  - Bodyguard - Benny Bereal
  - Cargo Ship Captain - Robin Hill
  - Club Paradise Guide - Kenneth Won
  - Coco - Ivy Tsui
  - Curious Tourist - Enzo di Bonaventura
  - Curtis - Whoopie Van Raam
  - Cute Girl on Boat - Longxi
  - Cute Guy on Boat - Narisu Bai
  - DJ - Page Kennedy
  ...
  - Lance - Felix Mayr
  - Leary Crewman - Matthew Stirling
  - Mac - Cliff Curtis
  - Meiying - Shuya Sophia Cai
  - Mercenary - Billy Clements
  - Mercenary - Doug Robson
  - Mercenary - Jonny James
  - Mercenary - Ron Smoorenburg
  - Mercenary Pilot - Richard Glover
  - Montes - Sergio Peris-Mencheta
  - Newlywed Woman - Jingjing Cai
  - Parrot / Suit Voice - Sara Dee
  - Party Guest - Tao Guo
  - Pippin the Dog - Macho
  - Rigas - Melissanthi Mahut
  - Sal - Kiran Sonia Sawar
  - Technician - Ricky Bevins
  - Tourist Businessman - Stewart Alexander
  - Tourists' Friend - Able Wanamakok
  - Tourists' Friend - Xiong Jinji
  - Waitress - Emily Ng
