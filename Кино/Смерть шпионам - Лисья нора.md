...
Время: 47 min
Режисер:
  - "Oleksandr Daruha (Александр Борисович Даруга)"
Актеры:
  - "Pavel Trubiner (Павел Константинович Трубинер)"
  - "Anatoly Rudenko (Руденко, Анатолий Кириллович)"
  - "Veronika Plyashkevich (Пляшкевич, Вероника Николаевна)"
  - "Aleh Tkachou (Олег Ткачёв)"
  - "Carl Achleitner (Карл Ахляйтнер)"
