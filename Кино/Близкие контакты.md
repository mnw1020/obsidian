...
Время: 119 min
Режисер:
  - "Eric Demeusy (Эрик Демьюзи)"
Актеры:
  - "Ryan Masson (Райан Массон)"
  - "Highdee Kuan (Хайди Куан)"
  - "Christian Prentice (Кристиан Прентис)"
  - "Shou Dzhons (Шоу Джонс)"
  - "Don Scribner (Дон Скрибнер)"
