...
Время: 112 min
Режисер:
  - "Frédéric Forestier (Фредерик Форестье)"
  - "Thomas Langmann (Тома Лангманн)"
Актеры:
  - "Gérard Depardieu (Жерар Депардьё)"
  - "Clovis Cornillac (Кловис Корнийяк)"
  - "Benoît Poelvoorde (Бенуа Пульворд)"
  - "Alain Delon (Ален Делон)"
  - "Vanessa Hessler (Ванесса Эсслер)"
