...
Время: 107 min
Режисер:
  - "Dennis Gansel (Деннис Ганзель)"
Актеры:
  - "Jürgen Vogel (Юрген Фогель)"
  - "Frederick Lau (Фредерик Лау)"
  - "Max Riemelt (Макс Римельт)"
  - "Jennifer Ulrich (Дженнифер Ульрих)"
  - "Christiane Paul (Кристиана Пауль)"
