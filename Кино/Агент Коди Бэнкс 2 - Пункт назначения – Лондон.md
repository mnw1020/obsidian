...
Время: 100 min
Режисер:
  - Kevin Allen (Кевин Аллен)
Актеры:
  - Frankie Muniz (Фрэнки Муниз) - Cody Banks (Кодй Банкс)
  - Anthony Anderson (Энтони Андерсон) - Derek (Дерек)
  - Hannah Spearritt (Ханна Спирритт) - Emily (Емилй)
  - Cynthia Stevenson (Синтия Стивенсон) - Mrs. Banks (Мрс. Банкс)
  - Daniel Roebuck (Дэниэл Робак) - Mr. Banks (Мр. Банкс)
  - Anna Chancellor (Анна Ченселлор) - Jo Kenworth (Джо Кенворт)
  - Keith Allen (Кит Аллен) - Diaz (Диаз)
  - James Faulkner (Джеймс Фолкнер) - Kenworth (Кенворт)
  - David Kelly (Дэвид Келли) - Trival (Тривал)
  - Santiago Segura (Сантьяго Сегура) - Santiago (Сантиаго)
  - Connor Widdows (Коннор Виддоуз) - Alex Banks (Алекс Банкс)
  - Rod Silvers (Род Сильверс) - Kumar (Кумар)
  - Jack Stanley (Джек Стэнли) - Ryan (Рян)
  - Joshua Brody (Джошуа Броди) - Bender (Бендер)
  - Sarah McNicholas (Сара МакНиколас) - Marisa (Мариса)
  - Philip Pedersen (Филип Педерсен) - Bender's Mate (Бендер'С Мате)
  - Paul Kaye (Пол Кэй) - Neville (Невилле)
  - Harry Burton (Гарри Бертон) - Westminster Headmaster (Вестминстер Хеадмастер)
  - Julian Firth (Джулиан Фёрт) - Isambard Jerkalot (Исамбард Джеркалот)
