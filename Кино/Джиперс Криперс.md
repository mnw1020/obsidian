...
Время: 91 min
Режисер:
  - "Victor Salva (Виктор Сальва)"
Актеры:
  - "Gina Philips (Джина Филипс)"
  - "Justin Long (Джастин Лонг)"
  - "Jonathan Breck (Джонатан Брек)"
  - "Patricia Belcher (Патриша Белчер)"
  - "Brandon Smith (Брэндон Смит)"
