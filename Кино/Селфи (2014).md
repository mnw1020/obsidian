...
Режисер:
  ...
  - "Alex Hardcastle (Алекс Хардкасл)"
  - "Claire Scanlon (Клер Скэнлон)"
  - "Christine Gernon (Кристин Джернон)"
  - "Elliot Hegarty (Эллиот Хегарти)"
Актеры:
  - "Karen Gillan (Карен Гиллан)"
  - "John Cho (Джон Чо)"
  - "Allyn Rachel (Эллин Рэйчел)"
  - "Da'Vine Joy Randolph (Давайн Джой Рэндольф)"
  - "David Harewood (Дэвид Хэрвуд)"
