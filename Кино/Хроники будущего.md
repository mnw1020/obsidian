...
Время: 43 min
Режисер:
  - "Harold Becker (Харольд Беккер)"
  - "Jonathan Frakes (Джонатан Фрейкс)"
  - "Darnell Martin (Дарнелл Мартин)"
  - "Michael Petroni (Майкл Петрони)"
  - "Mark Rydell (Марк Райделл)"
Актеры:
  - "Stephen Hawking (Стивен Хокинг)"
  - "Jason Diablo (Джейсон Диабло)"
  - "Paul Herbert (Пол Херберт)"
  - "Klifton Kollinz Ml. (Клифтон Коллинз мл.)"
