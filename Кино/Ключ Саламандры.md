...
Время: 103 min
Режисер:
  - "Aleksandr Yakimchuk (Александр Якимчук)"
  - "Elena Kovaleva (Ковалёва, Елена Васильевна)"
Актеры:
  - "Rutger Hauer (Рутгер Хауэр)"
  - "Michael Madsen (Майкл Мэдсен)"
  - "Fedor Emelianenko (Фёдор Владимирович Емельяненко)"
  - "Paweł Deląg (Павел Делонг)"
  - "Kim Bo-sung (Ким Бо-сон)"
