...
Время: 52 min
Режисер:
  - "Vladimir Raksha (Владимир Владимирович Ракша)"
Актеры:
  - "Irina Martynenko (Ирина Мартыненко)"
  - "Ilya Malanin (Илья Маланин)"
  - "Wolfgang Cerny (Вольфганг Черни)"
  - "Aleksey Serebryakov (Алексей Серебряков)"
  - "Linda Lapin'sh (Линда Лапиньш)"
