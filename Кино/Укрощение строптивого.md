...
Время: 107 min
Режисер:
  - "Franco Castellano (Франко Кастеллано)"
  - "Giuseppe Moccia (Джузеппе Мочча)"
Актеры:
  - "Adriano Celentano (Адриано Челентано)"
  - "Ornella Muti (Орнелла Мути)"
  - "Edith Peters (Эдит Питерс)"
  - "Pippo Santonastaso (Пиппо Сантонастасо)"
  - "Milly Carlucci (Милли Карлуччи)"
