...
Актеры:
  - "Aleksey Komashko (Комашко, Алексей Александрович)"
  - "Denis Shvedov (Денис Шведов)"
  - "Konstantin Strelnikov (Константин Стрельников)"
  - "Sergey Zharkov (Сергей Жарков)"
  - "Vladislav Toldykov (Владислав Толдыков)"
